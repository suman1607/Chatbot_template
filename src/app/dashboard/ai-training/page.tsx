...
const failedQuestionsData = [{
    question: "How do I add a team member on mobile?",
    frequency: 28,
}, {
    question: "Can I export my chat history to CSV?",
    frequency: 15,
}, {
    question: "What is your refund policy for yearly plans?",
    frequency: 9,
}, ];

const activityLogData = [{
    action: "Retrained AI with new data",
    timestamp: "2 hours ago",
    icon: < Bot className = "w-4 h-4 text-primary" / > ,
}, {
    action: "Uploaded 'pricing-faq.pdf'",
    timestamp: "1 day ago",
    icon: < FileText className = "w-4 h-4 text-green-500" / > ,
}, {
    action: "Website crawl completed for 'docs.example.com'",
        ...
        return ( <
            ...
            div className = "grid grid-cols-1 lg:grid-cols-3 gap-8" > {
                ...
                div className = "lg:col-span-2 space-y-8" > {
                    ...
                    defs >
                    <
                    linearGradient id = "coverageGradient"
                    x1 = "0"
                    y1 = "0"
                    x2 = "0"
                    y2 = "1" >
                    ...
                    div className = "space-y-8" > {
                        ...
                        placeholder = "e.g., 'Always mention our 14-day free trial...'"
                        ...
                        <
                        Input placeholder = "Ask your AI a question..."
                        className = "pr-10" / >
                        <
                        Button variant = "ghost"
                        size = "icon"
